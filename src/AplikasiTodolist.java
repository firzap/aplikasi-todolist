public class AplikasiTodolist {
    ...
    /**
     * Method untuk menambah todo list
     */
    public static void addTodoList(String todo){

        //cek apakah model array penuh
        var isFull = true;
        ...
        //jika model penuh, resize ukuran array 2x
        if (isFull){
            var temp = model;
        ...
        //insert data todo ke array model yg null
        for (var i = 0; i < model.length; i++){
            if (model[i] == null){
                model[i] = todo;
                break;
    ...
    /**
     * Method untuk menghapus todo list
     */
    ...
    public static void viewAddTodoList(){
        ...
        var todo = input("TO DO (x untuk membatalkan)");
    ...
    public static void viewRemoveTodoList(){
        ...
        var number = input("Nomor Todo List yang dihapus (x untuk membatalkan)");
